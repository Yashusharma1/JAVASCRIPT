...
argument. This function calculates the average of all numbers in the given array. 
...
for (let i = 0; i < bill.length; i++) {
  ...
  console.log(`The total value including the tip is ${total[i]}`);
}

console.log(total, tip, bill);

// NOW CREATE THE FUNCTION WITH TO CALCULATE THE AVERAGE
...
console.log(calcAverages([2, 3, 4, 5]));
